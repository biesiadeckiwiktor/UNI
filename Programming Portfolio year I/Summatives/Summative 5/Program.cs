...
string CheckName(string prompt)
{
   string name = string.Empty;
    do
    {
        ...
        if (name.Length > 6)
        {
            Console.WriteLine("Name must be less than 6 characters long");
            continue;
        }
        else
        {
...
do
    ...
    {
        string namePrompt= "What is your character's name?";
        Name = CheckName(namePrompt);
        do
        {
